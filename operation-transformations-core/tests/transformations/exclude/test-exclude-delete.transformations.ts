...
describe('Exclude delete from delete', (t) => {
  ...
  it('Exclude delete to the right', () => {
    ...
    const excludedTarget = excludeDeleteFromDelete(target, operation);
    const includedTarget = includeDeleteInDelete(excludedTarget, operation);
...
describe('Exclude insert from delete', (t) => {
  it('Exclude insert to the right', () => {
    ...
    const excludedTarget = excludeInsertFromDelete(target, operation);
    const includedTarget = includeInsertInDelete(excludedTarget, operation);
